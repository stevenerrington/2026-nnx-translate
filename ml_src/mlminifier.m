function mlminifier(dest,source,clearonly)

if ~exist('clearonly','var'), clearonly = false; end

if ~exist(dest,'dir'), error('The destination folder does not exist.'); end
