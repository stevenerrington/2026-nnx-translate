classdef analogoutput < dynamicprops
    ...
    properties (Access = protected, Constant)
        ...
        OutOfDataModeSet = {'Hold','DefaultValue'}
    ...
    methods (Hidden)
        function update_channels(obj)
            ...
            mdqmex(23,6,obj.AdaptorName,obj.DeviceID,obj.TaskID,param);
        end
    end
    ...
    methods
        function obj = analogoutput(adaptor,DeviceID)
            ...
            if ~any(idx), error('analogoutput:AdaptorNotFound','Failure to find requested data acquisition device: %s.',adaptor); end
            ...
            if ~any(idx), error('analogoutput:DeviceNotFound','Constructors require a device ID, e.g. analogoutput(''nidaq'',''Dev1'').'); end
        ...
        function start(obj)
            for m=1:length(obj)
                ...
                mdqmex(23,1,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID);
            end
        end
        function stop(obj,val)
            if ~exist('val','var'), val = 0; end
            for m=1:length(obj)
                mdqmex(23,2,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID,val);
            end
        end
        function trigger(obj)
            for m=1:length(obj)
                ...
                mdqmex(23,3,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID);
            end
        end
        function tf = isrunning(obj)
            ...
            tf = false(1,nobj);
            for m=1:nobj
                tf(m) = mdqmex(23,4,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID);
            end
         end
        function tf = issending(obj)
            ...
            tf = false(1,nobj);
            for m=1:nobj
                tf(m) = mdqmex(23,5,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID);
            end
        end
        ...
        function putdata(obj,data)
            ...
            mdqmex(23,101,obj.AdaptorName,obj.DeviceID,obj.TaskID,data');
        end
        function putsample(obj,sample)
            ...
            mdqmex(23,102,obj.AdaptorName,obj.DeviceID,obj.TaskID,sample');
        end
        ...
        function set.RepeatOutput(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'RepeatOutput',numchk(obj,val,0,Inf)); %#ok<*MCSUP>
        end
        function val = get.RepeatOutput(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'RepeatOutput');
        end
        ...
        function set.SampleRate(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SampleRate',numchk(obj,val,obj.hwInfo.MinSampleRate,obj.hwInfo.MaxSampleRate));
        ...
        function val = get.SamplesAvailable(obj)
            val = mdqmex(23,8,obj.AdaptorName,obj.DeviceID,obj.TaskID);
        end
        ...
        function val = get.SamplesOutput(obj)
            val = mdqmex(23,7,obj.AdaptorName,obj.DeviceID,obj.TaskID);
        end
        ...
        function val = get.WaveformsQueued(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'WaveformsQueued');
        end
        function set.ManualTriggerWFOutput(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerWFOutput',validateStringSet(obj,'ManualTriggerWFOutput',val));
        end
        function val = get.ManualTriggerWFOutput(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerWFOutput');
        end
        function set.ManualTriggerNextWF(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerNextWF',numchk(obj,val));
        end
        function val = get.ManualTriggerNextWF(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerNextWF');
        end
        function set.RegenerationMode(obj,val)
            ...
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'RegenerationMode',val);
        end
        function val = get.RegenerationMode(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'RegenerationMode');
        end
