...
%             end
    ...
    methods
        ...
        function obj = videocapture(adaptor,DeviceID)
            ...
            if ~any(idx), error('videocapture:AdaptorNotFound','Failure to find requested data acquisition device: %s.',adaptor); end
            ...
            if ~any(idx), error('videocapture:DeviceNotFound','The specified device ID is invalid. Use DAQHWINFO(adaptorname) to determine valid device IDs.'); end
        ...
        function trigger(obj)
            for m=1:length(obj)
                ...
                mdqmex(22,3,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID);
            end
        end
        ...
        function data = getdata(obj,nsamples)
            ...
            switch nargin
                case 1, data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,1);
                otherwise, data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,1,nsamples);
            end
        ...
        function data = peekdata(obj,nsamples)
            if 1 < length(obj), error('OBJ must be a 1-by-1 analog input object.'); end
            switch nargin
                case 1, data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,2);
                otherwise, data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,2,nsamples);
            end
            data.Frame = permute(data.Frame,[2 1 3]);
        end
        function data = getsample(obj)
            if 1 < length(obj), error('OBJ must be a 1-by-1 pointing device object.'); end
            data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,3);
            data.Frame = permute(data.Frame,[2 1 3]);
        end
        ...
        function data = peekfront(obj)
            if 1 < length(obj), error('OBJ must be a 1-by-1 pointing device object.'); end
            data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,4);
            data.Frame = permute(data.Frame,[2 1 3]);
        end
        ...
        function data = getback(obj)
            if 1 < length(obj), error('OBJ must be a 1-by-1 pointing device object.'); end
            data = mdqmex(28,obj.AdaptorName,obj.DeviceID,obj.TaskID,5);
            data.Frame = permute(data.Frame,[2 1 3]);
        end
        ...
        function set.FrameRate(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'FrameRate',numchk(obj,val,obj.FrameRateRange(1),obj.FrameRateRange(2)));
        end
        function val = get.FrameRate(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'FrameRate');
        end
        ...
        function val = get.SupportedFormat(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SupportedFormat');
        end
        function set.SelectedFormat(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SelectedFormat',numchk(obj,val)); %#ok<*MCSUP>
        end
        function val = get.SelectedFormat(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SelectedFormat');
        end
        function set.TriggerType(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerType',validateStringSet(obj,'TriggerType',val));
        end
        function val = get.TriggerType(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerType');
        end
        function set.VerticalFlip(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'VerticalFlip',numchk(obj,double(logical(val))));
        end
        function val = get.VerticalFlip(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'VerticalFlip');
        end
...
%             if isempty(obj.BrightnessRange), error('This capture device does not support brightness adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Brightness',numchk2(obj,val,obj.BrightnessRange));
        end
        function val = get.Brightness(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Brightness'),obj.BrightnessRange);
        end
...
%             if isempty(obj.ContrastRange), error('This capture device does not support contrast adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Contrast',numchk2(obj,val,obj.ContrastRange));
        end
        function val = get.Contrast(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Contrast'),obj.ContrastRange);
        end
        function set.Hue(obj,val)
%             if isempty(obj.HueRange), error('This capture device does not support hue adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Hue',numchk2(obj,val,obj.HueRange));
        end
        function val = get.Hue(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Hue'),obj.HueRange);
        end
...
%             if isempty(obj.SaturationRange), error('This capture device does not support saturation adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Saturation',numchk2(obj,val,obj.SaturationRange));
        end
        function val = get.Saturation(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Saturation'),obj.SaturationRange);
        end
...
%             if isempty(obj.SharpnessRange), error('This capture device does not support sharpness adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Sharpness',numchk2(obj,val,obj.SharpnessRange));
        end
        function val = get.Sharpness(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Sharpness'),obj.SharpnessRange);
        end
        function set.Gamma(obj,val)
%             if isempty(obj.GammaRange), error('This capture device does not support gamma adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Gamma',numchk2(obj,val,obj.GammaRange));
        end
        function val = get.Gamma(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Gamma'),obj.GammaRange);
        end
...
%             if isempty(obj.ColorEnableRange), error('This capture device does not support changing between color and black/white.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ColorEnable',numchk2(obj,val,obj.ColorEnableRange));
        end
        function val = get.ColorEnable(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ColorEnable'),obj.ColorEnableRange);
        end
...
%             if isempty(obj.WhiteBalanceRange), error('This capture device does not support white balance adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'WhiteBalance',numchk2(obj,val,obj.WhiteBalanceRange));
        end
        function val = get.WhiteBalance(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'WhiteBalance'),obj.WhiteBalanceRange);
        end
...
%             if isempty(obj.BacklightCompensationRange), error('This capture device does not support turning on/off backlight compensation.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'BacklightCompensation',numchk2(obj,val,obj.BacklightCompensationRange));
        end
        function val = get.BacklightCompensation(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'BacklightCompensation'),obj.BacklightCompensationRange);
        end
        function set.Gain(obj,val)
%             if isempty(obj.GainRange), error('This capture device does not support gain adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Gain',numchk2(obj,val,obj.GainRange));
        end
        function val = get.Gain(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Gain'),obj.GainRange);
        end
        function set.Pan(obj,val)
%             if isempty(obj.PanRange), error('This capture device does not support pan adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Pan',numchk2(obj,val,obj.PanRange));
        end
        function val = get.Pan(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Pan'),obj.PanRange);
        end
        function set.Tilt(obj,val)
%             if isempty(obj.TiltRange), error('This capture device does not support tilt adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Tilt',numchk2(obj,val,obj.TiltRange));
        end
        function val = get.Tilt(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Tilt'),obj.TiltRange);
        end
        function set.Roll(obj,val)
%             if isempty(obj.RollRange), error('This capture device does not support roll adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Roll',numchk2(obj,val,obj.RollRange));
        end
        function val = get.Roll(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Roll'),obj.RollRange);
        end
        function set.Zoom(obj,val)
%             if isempty(obj.ZoomRange), error('This capture device does not support zoom adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Zoom',numchk2(obj,val,obj.ZoomRange));
        end
        function val = get.Zoom(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Zoom'),obj.ZoomRange);
        end
...
%             if isempty(obj.ExposureRange), error('This capture device does not support exposure adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Exposure',numchk2(obj,val,obj.ExposureRange));
        end
        function val = get.Exposure(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Exposure'),obj.ExposureRange);
        end
        function set.Iris(obj,val)
%             if isempty(obj.IrisRange), error('This capture device does not support iris adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Iris',numchk2(obj,val,obj.IrisRange));
        end
        function val = get.Iris(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Iris'),obj.IrisRange);
        end
        function set.Focus(obj,val)
%             if isempty(obj.FocusRange), error('This capture device does not support focus adjustment.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Focus',numchk2(obj,val,obj.FocusRange));
        end
        function val = get.Focus(obj)
            val = formatoutput(obj,mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Focus'),obj.FocusRange);
        end
        
        function val = get.Width(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Width');
        end
        function val = get.Height(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'Height');
        end
        function val = get.FrameRateRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'FrameRateRange');
        end
        function val = get.BrightnessRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'BrightnessRange');
        end
        function val = get.ContrastRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ContrastRange');
        end
        function val = get.HueRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'HueRange');
        end
        function val = get.SaturationRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SaturationRange');
        end
        function val = get.SharpnessRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SharpnessRange');
        end
        function val = get.GammaRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'GammaRange');
        end
        function val = get.ColorEnableRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ColorEnableRange');
        end
        function val = get.WhiteBalanceRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'WhiteBalanceRange');
        end
        function val = get.BacklightCompensationRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'BacklightCompensationRange');
        end
        function val = get.GainRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'GainRange');
        end
        function val = get.PanRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'PanRange');
        end
        function val = get.TiltRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TiltRange');
        end
        function val = get.RollRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'RollRange');
        end
        function val = get.ZoomRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ZoomRange');
        end
        function val = get.ExposureRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ExposureRange');
        end
        function val = get.IrisRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'IrisRange');
        end
        function val = get.FocusRange(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'FocusRange');
        end
