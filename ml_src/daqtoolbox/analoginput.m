classdef analoginput < dynamicprops
    ...
    properties  % unimplemented string
        BufferingMode = 'Auto'
    ...
    properties (Hidden)  % unimplemented
        BufferingConfig = [64 30]
        ChannelSkew = 0.000004
    ...
    properties (Constant, Hidden)
        BufferingModeSet = {'Auto','Manual'}
        ChannelSkewModeSet = {'Minimum','Equisample','Manual'}
        ClockSourceSet = {'Internal','ExternalScanCtrl','ExternalSampleCtrl','ExternalSampleAndScanCtrl'}
        LoggingModeSet = {'Disk','Memory','Disk&Memory'}
        LogToDiskModeSet = {'Overwrite','Index'}
    ...
    methods (Access = protected)
        ...
        function events = getdaqevents(obj)
            events = mdqmex(27,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID);
    ...
    methods (Hidden)
        function update_channels(obj)
            ...
            mdqmex(22,6,obj.AdaptorName,obj.DeviceID,obj.TaskID,param);
        end
    end
    ...
    methods
        function obj = analoginput(adaptor,DeviceID)
            hw = daqhwinfo;
            if any(strcmp('wasapi',daqhwinfo('all'))), hw.InstalledAdaptors = [hw.InstalledAdaptors; 'wasapi']; end
            idx = strncmpi(hw.InstalledAdaptors,adaptor,length(adaptor));
            if ~any(idx), error('analoginput:AdaptorNotFound','Failure to find requested data acquisition device: %s.',adaptor); end
            ...
            if ~any(idx), error('analoginput:DeviceNotFound','Constructors require a device ID, e.g. analoginput(''nidaq'',''Dev1'').'); end
        ...
        function flushdata(obj,mode)
            ...
            for m=1:length(obj)
                ...
                mdqmex(22,10,obj(m).AdaptorName,obj(m).DeviceID,obj(m).TaskID,strcmpi(modeSet(2),mode));
            end
        end
        function varargout = getdata(obj,nsamples)
            if 1 < length(obj), error('OBJ must be a 1-by-1 analog input object.'); end
            switch nargin
                case 1, [data,info] = mdqmex(22,101,obj.AdaptorName,obj.DeviceID,obj.TaskID);
                otherwise, [data,info] = mdqmex(22,101,obj.AdaptorName,obj.DeviceID,obj.TaskID,nsamples);
            end
            varargout{1} = data';
            if 1<nargout
            ...
            if 3<nargout
                if isempty(info.AbsSample)
                    ...
                    events = mdqmex(27,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,info.AbsSample(1,1),info.AbsSample(end,2));
                    for m=1:length(events), events(m).Data.AbsTime = datevec(events(m).Data.AbsTime); end
                    varargout{4} = events;
                end
            end
        ...
        function val = get.InitialTriggerTime(obj)
            val = datevec(mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InitialTriggerTime'));
        end
        function set.InputType(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputType',validateStringSet(obj,'InputType',val)); %#ok<*MCSUP>
        end
        function val = get.InputType(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputType');
        end
        ...
        function set.ManualTriggerHwOn(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerHwOn',validateStringSet(obj,'ManualTriggerHwOn',val));
        end
        function val = get.ManualTriggerHwOn(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'ManualTriggerHwOn');
        end
        ...
        function set.SampleRate(obj,val)
            if ~strcmpi(obj.AdaptorName,'wasapi'), val = numchk(obj,val,obj.hwInfo.MinSampleRate,obj.hwInfo.MaxSampleRate); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SampleRate',val);
            obj.hwInfo = about(obj);  % Supported formats of devices (e.g., sound boards) may change depending on the rate.
        end
        ...
        function set.SamplesPerTrigger(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SamplesPerTrigger',numchk(obj,val));
        end
        function val = get.SamplesPerTrigger(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'SamplesPerTrigger');
        end
        function set.TriggerChannel(obj,ch)
            if ~strcmpi(class(ch),'aichannel'), error('Invalid or deleted object.'); end
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerChannel',ch.Index);
        end
        function val = get.TriggerChannel(obj)
            val = obj.Channel(mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerChannel'));
        end
        function set.TriggerCondition(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerCondition',validateStringSet(obj,'TriggerCondition',val));
        end
        function val = get.TriggerCondition(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerCondition');
        end
        function set.TriggerConditionValue(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerConditionValue',numchk(obj,val,2));
        end
        function val = get.TriggerConditionValue(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerConditionValue');
        end
        function set.TriggerDelay(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelay',numchk(obj,val));
        end
        function val = get.TriggerDelay(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelay');
        end
        function set.TriggerDelayUnits(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelayUnits',validateStringSet(obj,'TriggerDelayUnits',val));
        end
        function val = get.TriggerDelayUnits(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerDelayUnits');
        end
        function set.TriggerRepeat(obj,val)
            mdqmex(25,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerRepeat',numchk(obj,val));
        end
        function val = get.TriggerRepeat(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggerRepeat');
        end
        ...
        function val = get.TriggersExecuted(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'TriggersExecuted');
        end
        ...
        function val = get.InputTypeSet(obj)
            val = mdqmex(26,obj.AdaptorName,obj.DeviceID,obj.SubsystemType,obj.TaskID,'InputTypeSet');
        end
